...
public class Main {
    ...
    public static void main(String[] args) {
        /* Testo = "=SE(E([@Stato]<>\"Chiuso\";[@Stato]<>\"Risolto\";O(E([@OdL]<>\"\";O([@Categoria]=\"SDLC Light\";VAL.NUMERO([@OdL])));
        E([@OdL]=\"\";[@Categoria]<>\"SDLC Light\")));SE([@Age]<>\"\";[@Age]*PesoAge;0)+SE([@[Solleciti SD]]<>\"\";[@[Solleciti SD]]*PesoSolleciti;0)
        +SE(SINISTRA([@Priorità];1)=\"1\";PesoCritico;SE(SINISTRA([@Priorità];1)=\"2\";PesoAlto;SE(SINISTRA([@Priorità];1)=\"3\";PesoModerato;
        SE(SINISTRA([@Priorità];1)=\"4\";PesoBasso;PesoPianificato))))+SE(E([@OdL]<>\"\";VAL.NUMERO([@OdL]));OdLStart-[@OdL]*OdLLevel;0)+SE([@Stato]=\"In Progress\";PesoStato;0)
        +SE(SINISTRA([@Numero];3)=\"INC\";PesoTipo;0);SE(O([@Stato]=\"Chiuso\";[@Stato]=\"Risolto\");-1;SE([@Categoria]=\"SDLC Light\";-2;0)))"; */
    ...
    public static void Prettify(String formula){
        ...
        /* Trasforma la stringa in un array di caratteri e
            cicla dal primo all'ultimo */
